...
class GameScreen extends ConsumerWidget {
  ...
  return PieMenu(
    actions: [
      PieAction(
        tooltip: const Text('Убить', style: TextStyle(color: Colors.white)),
        onSelect: () {
          print('Убить игрока ${player.seatNumber}');
          gameNotifier.setAlive(player.seatNumber, false);
        },
        child: const Icon(Icons.skull, color: Colors.red, size: 28),
      ),
      PieAction(
        tooltip: const Text('Оживить', style: TextStyle(color: Colors.white)),
        onSelect: () {
      ...
      PieAction(
        tooltip: const Text('Выставить', style: TextStyle(color: Colors.white)),
        onSelect: () {
      ...
      PieAction(
        tooltip: const Text('Снять', style: TextStyle(color: Colors.white)),
        onSelect: () {
