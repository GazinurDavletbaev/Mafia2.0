...
extension GameStateSerialization on GameState {
  Map<String, dynamic> toJson() {
    ...
    return {
      ...
      'removedPlayers': removedPlayers.map((p) => p.toJson()).toList(),
      'votes': votes,
      ...
      'stageName': stageName,
      'ppkPlayerSeat': ppkPlayerSeat, // 🔥 ДОБАВЛЯЕМ
  ...
  static GameState fromJson(Map<String, dynamic> json) {
    ...
    return GameState(
      ...
      ppkPlayerSeat: json['ppkPlayerSeat'], // 🔥 ДОБАВЛЯЕМ
      showAllRoles: json['showAllRoles'] ?? false,
    );
  }
}
