...
extension GameStateConverters on GameState {
  ...
  List<Kill> toKillModels() => pendingKills;
  List<Vote> toVoteModels() => pendingVotes;
  List<BestMove> toBestMoveModels() => pendingBestMoves;
  List<GameLog> toGameLogModels() => pendingLogs;
}
