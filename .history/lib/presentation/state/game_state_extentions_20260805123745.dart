...
extension GameStateGetters on GameState {
  ...
  // 🔥 ИГРОК, КОТОРЫЙ УСТРОИЛ ППК
  PlayerModel? get ppkPlayer {
    if (ppkPlayerSeat == null) return null;
    return getPlayerBySeat(ppkPlayerSeat!);
  }
  
  // 🔥 БЫЛ ЛИ ППК В ЭТОЙ ИГРЕ
  bool get hasPpk => ppkPlayerSeat != null;
}
