...
import '../../domain/entities/speech_stack.dart';
import '../../domain/entities/vote_stack.dart';
...
class GameState {
  ...
  const GameState({
    ...
    required this.phaseStack,
    required this.speechStack,
    required this.voteStack,
  });
