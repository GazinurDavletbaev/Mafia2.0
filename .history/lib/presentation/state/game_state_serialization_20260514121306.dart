...
extension GameStateSerialization on GameState {
  Map<String, dynamic> toJson() {
    return {
      ...
      эphaseStack': phaseStack.history,
  ...
  static GameState fromJson(Map<String, dynamic> json) {
    ...
    final phaseStack = PhaseStack.fromHistory(phaseStackHistory);

    final speechStackHistory = json['speechStack'] as List<dynamic>? ?? [];
    final speechStack = SpeechStack.fromHistory(speechStackHistory);

    final voteStackHistory = json['voteStack'] as List<dynamic>? ?? [];
    final voteStack = VoteStack.fromHistory(voteStackHistory);
