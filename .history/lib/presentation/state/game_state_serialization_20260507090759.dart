...
extension GameStateSerialization on GameState {
  ...
  static GameState fromJson(Map<String, dynamic> json) {
    // Исправлено: безопасное преобразование List<dynamic> в List<PlayerModel>
    ...
    // Исправлено: безопасное преобразование для pendingKills
    ...
    // Исправлено: безопасное преобразование для pendingBestMoves
    ...
    // Исправлено: безопасное преобразование для pendingVotes
    ...
    // Исправлено: безопасное преобразование для pendingLogs
