...
import 'package:mafia_help/application/providers/show_timer_provider.dart';
...
class TimerOverAll extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final showGlobalTimer = ref.watch(showGlobalTimerProvider);

    print('🔍 TimerOverAll: seconds = $seconds, isRunning = $isRunning, show = $showGlobalTimer');

    // 🔥 ЕСЛИ СКРЫТ — НЕ ПОКАЗЫВАЕМ
    if (!showGlobalTimer) {
