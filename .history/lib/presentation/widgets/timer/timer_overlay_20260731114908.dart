...
class _TimerOverlayState extends State<TimerOverlay> {
  ...
  Widget build(BuildContext context) {
    ...
    // 🔥 ПОЗИЦИЯ ДЛЯ ЦИФР (зависит от количества знаков)
    final bool isTwoDigits = _currentSeconds >= 10;
    final double leftOffset = isTwoDigits ? 48 : 54;
          ...
          child: Container(
            ...
            child: Center(
              child: Text(
                '$_currentSeconds',
                style: TextStyle(
                  color: _currentSeconds <= 10 ? Colors.red : Colors.grey.shade700,
                  fontSize: 16,
