    ...
    return Positioned(
      ...
      child: IgnorePointer(
        child: Container(
          ...
          child: CustomPaint(
            painter: BottomNavBorderProgressPainter(
              progress: progress,
...
class BottomNavBorderProgressPainter extends CustomPainter {
  final double progress;
  final Color color;
  final double strokeWidth;

  BottomNavBorderProgressPainter({
  ...
  bool shouldRepaint(covariant CustomPainter oldDelegate) {
    if (oldDelegate is BottomNavBorderProgressPainter) {
