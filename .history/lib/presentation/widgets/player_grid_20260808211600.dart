...
class PlayerGrid extends StatelessWidget {
  ...
  return Column(
    ...
    children: playersList.map((player) {
      ...
      if (currentSubPhase == SubPhase.freeSeating) {
        // В freeSeating — все игроки зелёные, у всех таймер
        isSpeaking = true;
        timerValue = timerSeconds; // 🔥 ТАЙМЕР У ВСЕХ
      } else {
        // В других фазах — только текущий говорящий
        isSpeaking = currentSpeaker == player.seatNumber;
        timerValue = isSpeaking ? timerSeconds : null;
      }
