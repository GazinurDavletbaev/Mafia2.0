...
class _FloatingCalculatorState extends ConsumerState<FloatingCalculator> {
  ...
  Widget build(BuildContext context) {
    ...
    final clampedLeft = _position.dx.clamp(0.0, screenWidth - _width);
    final clampedTop = _position.dy.clamp(0.0, screenHeight - 280);
        ...
        onPanUpdate: (details) {
          if (_isDragging) {
            setState(() {
              ...
              _position = Offset(
                _position.dx.clamp(0.0, screenWidth - _width),
                _position.dy.clamp(0.0, screenHeight - 280),
              );
            });
          }
        },
