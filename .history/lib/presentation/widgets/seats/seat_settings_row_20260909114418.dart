...
class SeatSettingsRow extends StatelessWidget {
  ...
  final Map<String, GlobalKey>? tutorialKeys; // ← ДОБАВЛЕНО
            ...
            children: [
              Flexible(
                ...
                child: _buildSmallTextField(
                  context,
                  key: tutorialKeys?['seat_tournament'], // ← ПРИВЯЗКА
              ...
              Flexible(
                ...
                child: _buildSmallTextField(
                  context,
                  key: tutorialKeys?['seat_table'], // ← ПРИВЯЗКА
              ...
              Flexible(
                ...
                child: _buildSmallTextField(
                  context,
                  key: tutorialKeys?['seat_game'], // ← ПРИВЯЗКА
          ...
          Row(
            children: [
              Flexible(
                ...
                child: _buildSmallTextField(
                  context,
                  key: tutorialKeys?['seat_stadia'], // ← ПРИВЯЗКА
              ...
              Flexible(
                flex: 2,
                child: InkWell(
                  key: tutorialKeys?['seat_date'], // ← ПРИВЯЗКА
                  onTap: onDateTap,
                  child: Container(
                    padding:
