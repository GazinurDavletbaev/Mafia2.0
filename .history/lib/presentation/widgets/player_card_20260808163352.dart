...
class PlayerCard extends StatelessWidget {
  ...
  // 🔥 ВЫБОР РАМКИ ПО РОЛИ
  String? _getBorderImage() {
    if (!player.isAlive) return null;
    switch (player.role) {
      case 'don':
        return 'assets/donborder.png';
      case 'mafia':
        return 'assets/mafiaborder.png';
      case 'sheriff':
        return 'assets/sheriffborder.png';
      case 'citizen':
        return 'assets/citizenborder.png';
      default:
        return null;
    }
  }
  ...
  Widget _buildCard(BuildContext context) {
    ...
    final borderImage = _getBorderImage();
