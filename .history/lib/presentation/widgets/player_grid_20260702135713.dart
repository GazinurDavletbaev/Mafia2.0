...
class PlayerGrid extends StatelessWidget {
  ...
  Widget _buildNightActionValue(int? value, bool isActive, BuildContext context) {
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
    if (value == null) return const SizedBox(height: 28);
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        isNight ? _buildNightActionsColumn(context) : _buildDayColumn(context),
        Expanded(child: _buildColumn(rightColumn, false, timerSeconds, context)),
      ],
    );
  }
