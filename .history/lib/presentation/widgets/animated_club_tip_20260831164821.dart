          ...
          child: CustomPaint(
            ...
            child: Container(
              margin: EdgeInsets.only(
                top: widget.arrowDirection == 'up' ? 18.0 : 0.0,
                bottom: widget.arrowDirection == 'down' ? 18.0 : 0.0,
              ),
...
class TipPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (arrowDirection == 'down') {
      ...
      // Хвостик с закруглением (как в телеграмме)
      path.moveTo(x - 10.0, y);
      path.quadraticBezierTo(x - 12.0, y + 4.0, x - 6.0, y + 10.0);
      path.lineTo(x - 2.0, y + 16.0);
      path.quadraticBezierTo(x, y + 18.0, x + 2.0, y + 16.0);
      path.lineTo(x + 6.0, y + 10.0);
      path.quadraticBezierTo(x + 12.0, y + 4.0, x + 10.0, y);
      path.close();
