...
class Tutorials {
  ...
  static final List<TutorialStep> noclubSteps = [
    TutorialStep(
      ...
      description:
          'Здесь вы можете создавать клубы, управлять играми и отслеживать статистику игроков. Давайте покажем, как всё работает!',
      icon: Icons.emoji_emotions_rounded,
      backgroundColor: Colors.deepPurple.withOpacity(0.6),
      width: 320,
      height: 160,
      customPosition: const Offset(0, 200), // ← ПО ЦЕНТРУ ЭКРАНА
    ),
    TutorialStep(
      id: 'club_create',
