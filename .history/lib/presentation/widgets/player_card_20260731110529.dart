...
class PlayerCard extends StatelessWidget {
  ...
  Widget _buildCard(BuildContext context) {
    ...
    if (!player.isAlive) {
      backgroundColor = isDark ? Colors.black54 : Colors.grey.shade700;
    ...
    // 🔥 LayoutBuilder для получения размеров карточки
            ...
            if (isSpeaking && timerSeconds != null)
              Positioned.fill(
                child: TimerOverlay(
                  ...
                  width: cardWidth - 4,   // 🔥 ШИРИНА КАРТОЧКИ (с отступом)
                  height: cardHeight - 4, // 🔥 ВЫСОТА КАРТОЧКИ (с отступом)
                  strokeWidth: 4,
                ),
              ),
          ],
