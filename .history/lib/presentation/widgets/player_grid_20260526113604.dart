...
class PlayerGrid extends StatelessWidget {
  ...
  IconData _getIconForPhase() {
  switch (currentSubPhase) {
    case SubPhase.mafiaShoot:
      return Icons.sports_mma;  // боевое искусство/пистолет (или Icons.offline_bolt)
    case SubPhase.donCheck:
      return Icons.emoji_people;  // шляпа/человек
    case SubPhase.sheriffCheck:
      return Icons.search;  // лупа
    case SubPhase.sheriffLook:
      return Icons.remove_red_eye;  // глаз
    case SubPhase.contract:
      return Icons.handshake;  // рукопожатие
    case SubPhase.freeSeating:
      return Icons.chair;  // стул
    default:
      return Icons.thumb_up;  // рука с пальцем
  }
}
