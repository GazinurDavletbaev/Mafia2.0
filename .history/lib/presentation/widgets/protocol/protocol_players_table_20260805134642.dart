...
class ProtocolPlayersTable extends StatelessWidget {
  ...
  Widget _buildBonusPointsCell(int index, PlayerModel player) {
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
    ...
    if (isRemoved) {
      return _buildRemovedDropdown(index, player, isDark);
    }

    return _buildBonusDropdown(index, isDark);
  }

  Widget _buildRemovedDropdown(int index, PlayerModel player, bool isDark) {
  ...
  Widget _buildBonusDropdown(int index, bool isDark) {
