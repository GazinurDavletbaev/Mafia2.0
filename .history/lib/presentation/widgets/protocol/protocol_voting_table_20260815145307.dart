...
class ProtocolVotingTable extends StatelessWidget {
  ...
  Widget _buildVoteCard(
    ...
    // 🔥 ПЕРВЫЙ РАУНД
    final firstRound = rounds.isNotEmpty ? rounds[0] : {};
    final firstRoundKeys = firstRound.keys.toList()..sort();
        ...
        child: Column(
          ...
          children: [
            ...
            if (rounds.length > 1) ...[
              ...
              final secondRound = rounds[1];
              final secondKeys = secondRound.keys.toList()..sort();
