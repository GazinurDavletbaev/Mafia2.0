...
class ClubHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isPresident = club?['president_id'] == myClubId;
            ...
            children: [
              ...
              Stack(
                ...
                children: [
                  ...
                  // 🔥 БЕЙДЖ 4: ПОДАТЬ ЗАЯВКУ (СНИЗУ ПО ЦЕНТРУ) — ПОКАЗЫВАЕМ ТОЛЬКО ЕСЛИ:
                  // - пользователь НЕ состоит в клубе (userHasClub == false)
                  // - ИЛИ это не его клуб (isMyClub == false)
                  // - И НЕ президент (isPresident == false)
                  if (!isPresident && !userHasClub)
                    Positioned(
                      bottom: -22,
                      left: 74,
                      child: GestureDetector(
                  ...
                  // 🔥 ЕСЛИ ПОЛЬЗОВАТЕЛЬ ПРЕЗИДЕНТ — ПОКАЗЫВАЕМ КОРОНУ
                  if (isPresident)
                    Positioned(
                      bottom: -22,
                      left: 74,
