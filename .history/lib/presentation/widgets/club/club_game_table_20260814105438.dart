...
class _ClubGamesTableState extends State<ClubGamesTable> {
  ...
  child: game['winner'] == 'red'
      ? const Icon(Mdi.circle, color: Colors.red, size: 24)
      : game['winner'] == 'black'
          ? const Icon(Mdi.circle, color: Colors.black, size: 24)
          : const Icon(Mdi.helpCircle, color: Colors.grey, size: 24),
),
                  ),
                  // 🔥 НАЗВАНИЕ (МЕНЬШЕ)
                  title: Text(
                  ...
                  trailing: IconButton(
                    icon: Icon(
                      countsInRating ? Mdi.deleteClock : Mdi.deleteRestore,
