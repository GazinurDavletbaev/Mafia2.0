                ...
                return Table(
                  ...
                  children: [
                    ...
                    ...players.asMap().entries.map((entry) {
                      ...
                      return _buildRow(context, index, player, total, isTop);
                    }).toList(),
                  ],
                );
              },
  ...
  TableRow _buildHeader(BuildContext context) {
    return TableRow(
      children: [
        ...
        _cell(context, 'Игрок', isHeader: true),
        _cell(context, 'Игр', isHeader: true, align: TextAlign.center),
        _cell(context, 'Побед', isHeader: true, align: TextAlign.center),
        _cell(context, 'Очки', isHeader: true, align: TextAlign.center),
        _cell(context, 'Бонус', isHeader: true, align: TextAlign.center),
        _cell(context, 'Всего', isHeader: true, align: TextAlign.center),
      ],
    );
  }
