...
class ClubRatingTable extends StatelessWidget {
  ...
  columnWidths: {
    ...
    1: const FlexColumnWidth(3),     // Никнейм — растягивается (3 части)
  ...
  children: [
    TableRow(
      children: [
        _cell(context, '№', isHeader: true, align: TextAlign.center),
        _cell(context, 'Никнейм', isHeader: true, align: TextAlign.center),
        _cell(context, 'И', isHeader: true, align: TextAlign.center),
        _cell(context, 'П', isHeader: true, align: TextAlign.center),
        _cell(context, 'Б', isHeader: true, align: TextAlign.center),
        _cell(context, 'Д', isHeader: true, align: TextAlign.center),
        _cell(context, 'О', isHeader: true, align: TextAlign.center),
      ],
    ),
    ...players.asMap().entries.map((entry) {
      ...
      return TableRow(
        children: [
          _cell(context, '${index + 1}', isTop: isTop, align: TextAlign.center),
          _cell(
            context,
