...
class ClubRatingTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      // ❌ УБИРАЕМ elevation И shadowColor
      // elevation: 4,
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: Colors.white.withOpacity(0.2), // Белая тень
              blurRadius: 25, // Размытие
              spreadRadius: 0.2, // Распространение
              offset: Offset.zero, // 🔥 ВО ВСЕ СТОРОНЫ
            ),
          ],
        ),
        child: Padding(
