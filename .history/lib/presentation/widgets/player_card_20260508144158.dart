...
class PlayerCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    AppLogger.d(
      'PlayerCard.build(): seat=${player.seatNumber}, isSpeaking=$isSpeaking, timerSeconds=$timerSeconds, isAlive=${player.isAlive}',
    );
    ...
    if (isSpeaking && timerSeconds != null) {
      AppLogger.d(
        'PlayerCard: showing TimerOverlay for seat ${player.seatNumber}, seconds=$timerSeconds',
      );
      return TimerOverlay(
