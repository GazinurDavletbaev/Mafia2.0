...
class PlayerGrid extends StatelessWidget {
  ...
  if (nightActions.length > startIndex + 0) mafiaValue = nightActions[startIndex + 0];
  if (nightActions.length > startIndex + 1) donValue = nightActions[startIndex + 1];
  if (nightActions.length > startIndex + 2) sheriffValue = nightActions[startIndex + 2];
    return Container(
      width: 30,
      child: Column(
