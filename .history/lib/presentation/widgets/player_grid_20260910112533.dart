  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        Expanded(
            child: _buildColumn(
                leftColumn, true, timerSeconds, context, playerNumber)),
        Container(
          width: 100,
          child: Column(
        ...
        Expanded(
          child: _buildColumn(rightColumn, false, timerSeconds, context, null),
        ),
      ],
    );
  }
