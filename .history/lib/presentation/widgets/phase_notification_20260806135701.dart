...
class PhaseNotification extends StatefulWidget {
  final Phase phase;
  ...
  @override
  State<PhaseNotification> createState() => _PhaseNotificationState();
}

class _PhaseNotificationState extends State<PhaseNotification>
  ...
  Widget build(BuildContext context) {
    ...
    final bool isNight = widget.phase == Phase.night;
            ...
            child: Center(
              child: Container(
                constraints: const BoxConstraints(
                  maxWidth: 220, // 🔥 МАКСИМАЛЬНАЯ ШИРИНА
                ),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        ...
                        softWrap: true, // 🔥 ПЕРЕНОС ПО СЛОВАМ
