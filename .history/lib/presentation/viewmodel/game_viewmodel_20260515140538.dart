...
class GameViewModel extends StateNotifier<GameState> {
  ...
  final previousSpeaker = currentSpeaker != null ? currentSpeaker - 1 : null;
  ...
  if (currentPhase == lastSavedPhase && previousSpeaker == lastSavedSpeaker) {
    AppLogger.d('onPhaseBack: condition met (same phase and previousSpeaker matches lastSavedSpeaker), restoring last saved state without pop');
