...
class GameViewModel extends StateNotifier<GameState> {
  ...
  Future<void> onEndGame(GameResult result) => _gameplay.onEndGame(result);
  ...
  Future<void> _checkGameEnd() => _persistence.checkGameEnd();
  void _showGameEndDialog(GameResult result) => _persistence.showGameEndDialog(result);

  // ========== Вспомогательные ==========
  String _currentPhaseString() => _gameplay.currentPhaseString();
}