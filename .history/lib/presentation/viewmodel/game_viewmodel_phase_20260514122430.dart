...
class PhaseActions {
  ...
  if (nextPhase != null) {
    ...
    // Нет следующей фазы в текущем списке → переходим к следующему блоку (день или ночь)
    if (_vm.state.currentSubPhase is Night0Phase) {
    ...
    } else if (_vm.state.currentSubPhase is DayPhase) {
    ...
    } else if (_vm.state.currentSubPhase is NightPhase) {
