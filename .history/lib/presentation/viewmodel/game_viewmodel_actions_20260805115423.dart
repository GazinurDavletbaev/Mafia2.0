...
class PlayerActions {
  ...
  Future<void> _addTechFoul(int seatNumber) async {
    ...
    print('old: techFouls=${oldPlayer.techFouls}, isAlive=${oldPlayer.isAlive}');
    print('new: techFouls=${newPlayer.techFouls}, isAlive=${newPlayer.isAlive}');
