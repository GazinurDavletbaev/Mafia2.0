...
class GameplayActions {
  ...
  Future<void> onPlayerTap(int seatNumber) async {
    AppLogger.d('onPlayerTap: START seat=$seatNumber, currentSpeaker=${_vm.state.currentSpeakerSeat}, currentSubPhase=${_vm.state.currentSubPhase}');
    ...
    AppLogger.d('onPlayerTap: AFTER foul, currentSpeaker=${_vm.state.currentSpeakerSeat}');
    
    await _vm.onCheckGameEnd();
    AppLogger.d('onPlayerTap: AFTER onCheckGameEnd, currentSpeaker=${_vm.state.currentSpeakerSeat}');
  }
