...
class PhaseActions {
  ...
  Future<void> onPhaseBack() async {
    ...
    final newState = _vm.state.copyWith(
      ...
      currentPhase: nightPhases.contains(previousPhase) ? Phase.night : Phase.day,
    );
  ...
  Future<void> onPhaseForward() async {
    ...
    final shouldIncrement = _vm.state.currentSubPhase == SubPhase.finalWord && nextPhase == SubPhase.mafiaShoot;
