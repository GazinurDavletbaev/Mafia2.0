...
class PhaseActions {
  ...
  // Особый случай: переход из дня в ночь при нажатии назад на speeches
  if (previousPhase == SubPhase.speeches && newPhaseHistory.length >= 2) {
    final beforePrevious = newPhaseHistory[newPhaseHistory.length - 2];
    if (beforePrevious == SubPhase.mafiaShoot ||
        beforePrevious == SubPhase.donCheck ||
        beforePrevious == SubPhase.sheriffCheck) {
