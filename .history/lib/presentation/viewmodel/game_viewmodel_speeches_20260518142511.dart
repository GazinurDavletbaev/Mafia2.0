...
class SpeechesActions {
  ...
  Future<void> calculateSpeechHystory() async {
    AppLogger.d('calculate speech hystory');
  ...
  Future<void> nextSpeaker() async {
    ...
    if (_vm.state.speechHistory.isNotEmpty) {
      ...
      if (_vm.state.dayStarterSeat == null) {
        _vm.state = _vm.state.copyWith(dayStarterSeat: currentSpeaker);
      }
