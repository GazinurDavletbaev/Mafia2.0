    ...
    Future.delayed(const Duration(seconds: 2), () {
      ...
      switch (result.type) {
        ...
        case VoteResultType.tieBreak:
          // Сохраняем текущие голоса как revote для переголосования
          final revoteVotes = Map<int, int>.from(votes);

          voteDay = VoteDay(
            vote: {}, // основное голосование пустое, так как это переголосование
            revote: revoteVotes, // ← голоса переголосования
            eliminated: false,
            eliminationVotes: 0,
            result: [],
          );
