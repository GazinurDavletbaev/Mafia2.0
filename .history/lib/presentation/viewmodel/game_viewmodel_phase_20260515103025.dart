  ...
  Future<void> onPhaseForward() async {
    ...
    if (nextPhase == SubPhase.speeches) {
      ...
      if (allAlive.isNotEmpty) {
        final lastSpeaker = _vm.state.dayStarterSeat;
        int firstSpeaker;

        if (lastSpeaker != null) {
          // Ищем следующего живого после lastSpeaker
          final index = allAlive.indexOf(lastSpeaker);
    ...
    AppLogger.d('lastSpeaker from previous day = $lastSpeaker');
