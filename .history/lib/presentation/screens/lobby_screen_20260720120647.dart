...
void didChangeDependencies() {
  ...
  print('📦 didChangeDependencies: playerNames=${_gameData.playerNames}');
  
  // ✅ Если есть имена в _gameData — восстанавливаем
  if (_gameData.playerNames.isNotEmpty && _selectedIndex == 2) {
    // Передаём данные в SeatSetupScreen через обновление
    setState(() {});
  }
}
  ...
  print('📦 _gameData обновлён: playerNames=${_gameData.playerNames}');
}
