...
class _GameProtocolScreenState extends State<GameProtocolScreen> {
  ...
  // ✅ Если result есть и НЕ содержит ни одного игрока из rounds — это удаление
  final isRemoval = hasResult &&
      dayData.result.every((seat) => !allPlayersInRounds.contains(seat));
