  ...
  Future<void> _loadRating() async {
    ...
    if (result['success']) {
      setState(() {
        ...
        _ratingPlayers = (result['players'] as List? ?? []).cast<Map<String, dynamic>>();
      });
    }
  }
                  ...
                  children: [
                    ...
                    ..._ratingPlayers.asMap().entries.map((entry) {
                      ...
                      return TableRow(
                        decoration: BoxDecoration(
                          color: isTop
                              ? (isDark ? Colors.grey.shade700 : theme.primaryColor.withOpacity(0.1))
                              : null,
                        ),
                        children: [
                          _ratingCell(
                            '${index + 1}',
                            isTop: isTop,
                            color: isTop ? theme.primaryColor : null,
                          ),
                          _ratingCell(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: _club?['logo_url'] != null && _club!['logo_url'].isNotEmpty
                        ? DecorationImage(
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: _club?['president_avatar'] == null ||
                          ...
                          ? Text(
                              _club?['president_name']?.substring(0, 1).toUpperCase() ?? '?',
                              style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.games, color: theme.primaryColor, size: 16),
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            if (isOfficial) ...[
                                              const SizedBox(width: 4),
                                              Icon(Icons.verified, color: theme.primaryColor, size: 16),
                                            ],
                                          ],
                                        ),
