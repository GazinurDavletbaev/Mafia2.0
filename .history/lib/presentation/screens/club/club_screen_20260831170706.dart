...
import 'package:mafia_help/presentation/widgets/animated_club_tip.dart';
        ...
        children: [
          ...
          if (_showTip)
            AnimatedClubTip(
              onDismiss: () {
                setState(() {
                  _showTip = false; // Закрываем подсказку по крестику
                });
              },
              onAction: () {
                // Сюда можно добавить логику, если нажали на кнопку "Попробовать"
                print("Пользователь нажал кнопку в подсказке");
              },
              top: 250.0, // Отступ сверху (где будет находиться карточка)
              left: 16.0, // Отступ слева
              width: 300.0, // Ширина карточки
              height:
                  160.0, // Высота карточки (можно не указывать, будет дефолтная)

              // --- НАСТРОЙКИ СТРЕЛОЧКИ ---
              direction: TooltipDirection
                  .downRight, // Стрелочка вниз-вправо (как на картинке)
              arrowOffset: 0.8, // Позиция хвостика (0.8 = ближе к правому краю)

              // --- КОНТЕНТ ---
              title: '👥 Резиденты клуба',
              description:
                  'Нажмите на кнопку "Резиденты", чтобы увидеть список участников и управлять ими.',
              icon: Icons.group_add,
              buttonText: 'Попробовать',
              accentColor: Colors.purple, // Цвет иконки и кнопки
            ),
        ],
      ),
    );
