        ...
        : SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    _clubImage == null ? 'Нажмите для загрузки фото' : 'Нажмите чтобы сменить фото',
                    style: TextStyle(
                      fontSize: 12,
                ...
                const SizedBox(height: 16),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: const Icon(Icons.telegram, color: Colors.lightBlue),
                    ),
                  ),
                  const SizedBox(height: 12),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: const Icon(Icons.videocam, color: Colors.purple),
                    ),
                  ),
