...
class _GameScreenState extends ConsumerState<GameScreen> {
  ...
  final winnerText = winner == 'red' ? '🔴 ПОБЕДА КРАСНЫХ' : '⚫ ПОБЕДА ЧЁРНЫХ';
    ...
    builder: (context) => AlertDialog(
      ...
      actions: [
        TextButton(
          ...
          child: const Text('◀️ ОТМЕНА', style: TextStyle(color: Colors.grey)),
        ),
        TextButton(
          onPressed: () {
            Navigator.pop(context);
          ...
          child: const Text('📋 ПРОТОКОЛ ИГРЫ', style: TextStyle(color: Colors.orange)),
        ),
      ],
    ),
  );
