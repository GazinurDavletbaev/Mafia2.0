...
class _GameProtocolScreenState extends State<GameProtocolScreen> {
  ...
  // Победившая команда (true - красные, false - чёрные)
  late bool _redWon;

  @override
  void initState() {
    super.initState();
    _redWon = widget.gameState.winner == 'red';
    _points = List.generate(10, (index) {
      // Если команда победила, все живые игроки получают по 1 баллу
        ...
        child: DropdownButton<double>(
          ...
          items: bonusValues.map((value) {
            return DropdownMenuItem<double>(
              value: value,
              child:
                  Text(value.toStringAsFixed(1), textAlign: TextAlign.center),
            );
          }).toList(),
          onChanged: (newValue) {
            setState(() {
