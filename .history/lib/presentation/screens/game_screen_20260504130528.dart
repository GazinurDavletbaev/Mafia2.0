  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          PhaseHeader(
            phase: vm.state.currentPhase,
            subPhaseIndex: vm.state.currentSubPhaseIndex,
          ),
          Expanded(
            child: PlayerGrid(
              players: players,
              currentSpeaker: vm.state.currentSpeakerSeat,
          ...
          (
            ...
            subPhaseIndex: vmPhaseHeader.currentSubPhaseIndex,
          ),
          Expanded(
            child: PlayerGrid(
              players: players,
