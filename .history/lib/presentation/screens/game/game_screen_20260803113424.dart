...
import 'package:mafia_help/presentation/widgets/game_calculator.dart';
import 'package:mafia_help/presentation/widgets/game_navigation.dart';
...
// 🔥 КАЛЬКУЛЯТОР (появляется когда нужно)
            Positioned(
              bottom: 100,
              right: 70,
              child: const GameCalculator(),
            ),
            FloatingCalculator(),
          ],
        ),
