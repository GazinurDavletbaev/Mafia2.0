...
class _SeatSetupScreenState extends ConsumerState<SeatSetupScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ Восстанавливаем имена при каждом билде
    for (int i = 0; i < 10; i++) {
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: _buildTextField(index, isLeft)),
              ],
            ),
          ),
        );
  ...
  Widget _buildTextField(int index, bool isLeft) {
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
    final controller = _controllers[index];
    final members = _clubMembers;
