      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const Spacer(height), // 👈 ПОДНИМАЕТ КНОПКУ ВВЕРХ

            // В любом другом экране или виджете
            GameNewButton(
              onNewGame: () {
                // Логика создания новой игры
                print('Новая игра!');
              },
              label: 'СОЗДАТЬ НОВУЮ ИГРУ', // Можно изменить текст
              isFullWidth: true, // или false для компактного режима
            ),
            const SizedBox(height: 20),
          ],
        ),
