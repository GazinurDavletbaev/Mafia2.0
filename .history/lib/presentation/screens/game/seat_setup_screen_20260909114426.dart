...
class _SeatSetupScreenState extends ConsumerState<SeatSetupScreen> {
  ...
  final Map<String, GlobalKey> _tutorialKeys = {
    'seat_player': GlobalKey(),
    'seat_tournament': GlobalKey(),
    'seat_stadia': GlobalKey(),
    'seat_table': GlobalKey(),
    'seat_game': GlobalKey(),
    'seat_date': GlobalKey(),
    'seat_delete': GlobalKey(),
  };
  ...
  void _showTutorials() {
    ...
    TutorialManager.startTutorials(
      ...
      keys: _tutorialKeys,
      onAllCompleted: () {
        print('🎉 Подсказки рассадки показаны!');
      },
    );
  }
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            SeatSettingsRow(
              key: _tutorialKeys['seat_settings'],
