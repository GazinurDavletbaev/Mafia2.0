...
class _EditClubScreenState extends ConsumerState<EditClubScreen> {
  ...
  Future<void> _loadClubData() async {
    ...
    if (token != null) {
      final result = await ClubService.getClub(widget.club['id']);
  ...
  Future<void> _saveClub() async {
    ...
    if (result['success']) {
      ...
      setState(() {
        _currentLogoUrl = result['logo_url'] ?? _currentLogoUrl;
        _titleController.text = result['title'] ?? title;
        _descriptionController.text = result['description'] ?? description;
        _cityController.text = result['city'] ?? city;
