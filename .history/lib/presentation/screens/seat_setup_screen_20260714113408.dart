...
class _SeatSetupScreenState extends ConsumerState<SeatSetupScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Форматируем дату
    final dateStr =
        '${widget.initialData.date.day.toString().padLeft(2, '0')}.${widget.initialData.date.month.toString().padLeft(2, '0')}.${widget.initialData.date.year} ${widget.initialData.date.hour.toString().padLeft(2, '0')}:${widget.initialData.date.minute.toString().padLeft(2, '0')}';
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        'Турнир: ${widget.initialData.tournamentName}',
                        style: TextStyle(
                      ...
                      Text(
                        'Стадия: ${widget.initialData.stageName}',
                        style: TextStyle(
                          color: isDark ? Colors.white : Colors.black87,
                          fontSize: 12,
                        ),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        'Стол ${widget.initialData.tableNumber}',
                        style: TextStyle(
                          color: isDark ? Colors.white : Colors.black87,
                          fontSize: 12,
                        ),
                      ...
                      Text(
                        'Игра ${widget.initialData.gameNumber}',
                        style: TextStyle(
                          color: isDark ? Colors.white : Colors.black87,
                          fontSize: 12,
                        ),
