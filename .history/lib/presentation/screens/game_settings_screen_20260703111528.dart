...
class _GameSettingsScreenState extends ConsumerState<GameSettingsScreen> {
  ...
  void initState() {
    super.initState();
    _tournamentController = TextEditingController(text: widget.initialData.tournamentName);
    _stageController = TextEditingController(text: widget.initialData.stageName);
    _tableController = TextEditingController(text: widget.initialData.tableNumber.toString());
    _gameController = TextEditingController(text: widget.initialData.gameNumber.toString());
    _judgeController = TextEditingController(text: widget.initialData.judgeName);
