      ...
      return Padding(
        ...
        child: Container(
          ...
          child: GestureDetector(
            onTap: () {
              // Открываем Dropdown программно
              final RenderBox? renderBox =
                  context.findRenderObject() as RenderBox?;
              // Для открытия Dropdown используем DropdownButton с фокусом
            },
            child: Container(
              width: 52,
              alignment: Alignment.center,
              child: DropdownButton<String>(
                ...
                icon: const SizedBox.shrink(), // ← убираем иконку
                underline: const SizedBox.shrink(), // ← убираем подчёркивание
                isDense: true,
                isExpanded: true,
