...
class _GameScreenState extends ConsumerState<GameScreen> {
  ...
  void _handleVotingState() {
    ...
    AppLogger.d(
      '_handleVotingState: isVotingActive=${gameState.isVotingActive}, voteController=${gameState.voteController != null}',
    );
  ...
  ((_) {
      finavoid _showVoteBottomSheet(VoteController controller) {
    ...
    ).thenl newState = ref.read(gameViewModelFamily(widget.gameId));
