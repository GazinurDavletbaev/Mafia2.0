...
class _ClubScreenState extends ConsumerState<ClubScreen> {
  ...
  final List<Map<String, dynamic>> _allClubs = [
    {'id': 1, 'title': 'Mafia Legends', 'city': 'Казань', 'president': 'googlead', 'members': 15},
    {'id': 2, 'title': 'Black Mafia', 'city': 'Москва', 'president': 'ivanov', 'members': 23},
    {'id': 3, 'title': 'Red Town', 'city': 'Санкт-Петербург', 'president': 'petrov', 'members': 8},
    {'id': 4, 'title': 'Mafia Kings', 'city': 'Новосибирск', 'president': 'sidorov', 'members': 31},
    {'id': 5, 'title': 'Городская Мафия', 'city': 'Екатеринбург', 'president': 'smirnov', 'members': 12},
    {'id': 6, 'title': 'The Don', 'city': 'Казань', 'president': 'kozloff', 'members': 19},
    {'id': 7, 'title': 'Mafia Empire', 'city': 'Москва', 'president': 'morozov', 'members': 27},
  ];
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              Row(
                children: [
                  const Icon(Icons.emoji_events, color: Colors.yellow, size: 14),
  ...
  List<Map<String, dynamic>> _generatePlayers(int count) {
    final names = [
      'Алексей', 'Дмитрий', 'Сергей', 'Иван', 'Петр', 'Михаил',
      'Андрей', 'Николай', 'Олег', 'Владимир', 'Артем', 'Максим',
    ];
