...
class GameSettingsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GameSettingsScreen> createState() =>
...
class _GameSettingsScreenState extends ConsumerState<GameSettingsScreen> {
  ...
  Future<void> _loadCurrentUser() async {
    ...
    if (token != null) {
      ...
      if (result['success']) {
        ...
        setState(() {
          _currentUsername = user.nickname ?? 'Судья';
        });
        _notifyChanges();
      }
    }
  ...
  void _notifyChanges() {
    ...
    final updatedGameState = widget.initialData.gameState.copyWith(
      ...
      judgeName: _currentUsername ?? 'Судья',
    );
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        'Судья: ${_currentUsername ?? 'Загрузка...'}',
                        style: TextStyle(
                          color: isDark ? Colors.grey : Colors.grey.shade600,
                          fontSize: 14,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(child: _buildPlayersColumn(_leftSeats, isLeft: true)),
                      const SizedBox(width: 20),
                      Expanded(child: _buildPlayersColumn(_rightSeats, isLeft: false)),
                    ],
                  ),
                ],
              ),
