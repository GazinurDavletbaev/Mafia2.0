...
class GameLocalSource {
  ...
  Future<void> init() async {
    _gamesBox = await Hive.openBox<Game>(_gamesBox);
    _playersBox = await Hive.openBox<PlayerModel>(_playersBox);
    _killsBox = await Hive.openBox<Kill>(_killsBox);
    _votesBox = await Hive.openBox<Vote>(_votesBox);
    _bestMovesBox = await Hive.openBox<BestMove>(_bestMovesBox);
    _gameLogsBox = await Hive.openBox<GameLog>(_gameLogsBox);
