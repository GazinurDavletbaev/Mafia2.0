...
class GameRepositoryImpl implements GameRepository {
  ...
  @override
  Future<SubPhase> getCurrentSubPhase() async {
    return _notifier.state.currentSubPhase;
  }

  @override
Future<void> setCurrentSubPhase(SubPhase subPhase) async {
  _notifier.setSubPhase(subPhase);
}
