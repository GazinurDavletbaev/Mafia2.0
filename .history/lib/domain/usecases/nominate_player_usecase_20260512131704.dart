...
class NominatePlayerUsecase {
  ...
  Future<GameState> call(int seatNumber) async {
    ...
    AppLogger.d(
      'NominatePlayerUsecase: BEFORE - currentSpeaker=${state.currentSpeakerSeat}',
    );
    ...
    final updatedNominations = List<int>.from(state.nominatedSeats)
      ..add(seatNumber);
    ...
    AppLogger.d(
      'NominatePlayerUsecase: AFTER - currentSpeaker=${newState.currentSpeakerSeat}',
    );
