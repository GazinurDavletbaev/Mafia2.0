  ...
  static VoteResult determineResult(Map<int, int> votes, int aliveCount) {
    if (votes.isEmpty) {
      return VoteResult(
        winnerSeat: null,
        seats: [],
        type: VoteResultType.noCandidates, votesCount: null,
      );
    }
    ...
    if (winners.length == 1) {
      return VoteResult(
        ...
        seats: winners,
        type: VoteResultType.winner, votesCount: null,
      );
    }
    ...
    return VoteResult(
      winnerSeat: null,
      seats: winners,
      type: VoteResultType.tieBreak, votesCount: null, // всегда tieBreak, не eliminationVote
    );
  }
}
