...
class PhaseTransitionHelper {
  GameState nextPhase(GameState state) {
    ...
    if (state.currentSubPhaseIndex < subPhases.length - 1) {
      ...
      final nextSubPhase = nextSubPhases.isNotEmpty
          ? nextSubPhases[0]
          : SubPhase.contract;
      ...
      var newState = state.copyWith(
        ...
        currentDay: nextPhase == Phase.day
            ? state.currentDay + 1
            : state.currentDay,
      );
  ...
  GameState previousPhase(GameState state) {
    ...
    if (state.currentSubPhaseIndex > 0) {
      ...
      final previousSubPhase = previousSubPhases.isNotEmpty
          ? previousSubPhases.last
          : SubPhase.contract;
      ...
      var newState = state.copyWith(
        ...
        currentDay: previousPhase == Phase.day
            ? state.currentDay - 1
            : state.currentDay,
      );
