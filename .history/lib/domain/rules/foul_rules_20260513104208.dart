// lib/domain/rules/foul_rules.dart

class FoulRules {
  /// Добавить фол игроку.
  /// Возвращает:
  /// - newFouls: новое количество фолов
  /// - newIsAlive: новое состояние (жив/мёртв)
  /// 
  /// Правила:
  /// - Мёртвому игроку нельзя добавить фол
  /// - 0→1, 1→2, 2→3: жив
  /// - 3→4: умирает (isAlive = false)
  /// - 4→5: воскресает, фолы = 0, жив
