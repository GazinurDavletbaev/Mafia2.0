...
void main() {
  group('PlayerGrid отображение кандидатов', () {
    ...
    // Находит центральную колонку по иконке голосования
    Finder findCenterColumnByIcon(IconData icon) {
      final iconFinder = find.byIcon(icon);
      return find.ancestor(of: iconFinder, matching: find.byType(Container));
    }
    ...
    testWidgets('voting — отображает nominatedSeats', (tester) async {
      ...
      final centerColumn = findCenterColumnByIcon(Icons.how_to_vote);
    ...
    testWidgets('speeches — отображает выставленных кандидатов',
      ...
      final centerColumn = findCenterColumnByIcon(Icons.mic);
    ...
    testWidgets('tieBreak — отображает tiedSeats', (tester) async {
      ...
      final centerColumn = findCenterColumnByIcon(Icons.gavel);
    ...
    testWidgets('bestMove — отображает partialBestMove', (tester) async {
      ...
      final centerColumn = findCenterColumnByIcon(Icons.emoji_events);
    ...
    testWidgets('eliminationVote — отображает tiedSeats и голоса',
      ...
      final centerColumn = findCenterColumnByIcon(Icons.warning);
